...
void MainWindow::checkFifthTrainCanMove(int x, int y) {
    if ((ui->label_trem5->x() == 640 && ui->label_trem5->y() == 170) && (ui->label_trem2->x() > 620 && ui->label_trem2->x() <= 770 && ui->label_trem2->y() == 150) && fifthCriticalRegion.available() == 0) {
        ...
        trem5->wait(1);
     } else if ((ui->label_trem5->x() == 660 && ui->label_trem5->y() == 300) && (ui->label_trem4->x() == 640 && ui->label_trem4->y() >= 150) && seventhCriticalRegion.available() == 0) {
        // AWAIT FOURTH TRAIN
        seventhCriticalRegion.release(1);
        qDebug() << "RELEASE BY FIFTH TRAIN, SEVENTH CRITICAL REGION AVAILABLE: " << seventhCriticalRegion.available();
        trem5->setCanMove(TRAIN_CANNOT_MOVE);
        trem5->wait(1);
    } else if ((ui->label_trem5->x() == 660 && ui->label_trem5->y() == 300) && (ui->label_trem2->x() == 660 && ui->label_trem2->y() == 150) && seventhCriticalRegion.available() == 0) {
        // AWAIT SECOND TRAIN WHENT SECOND TRAIN AWAIT FOURTH TRAIN
        seventhCriticalRegion.release(1);
        qDebug() << "RELEASE BY FIFTH TRAIN, SEVENTH CRITICAL REGION AVAILABLE: " << seventhCriticalRegion.available();
        trem5->setCanMove(TRAIN_CANNOT_MOVE);
        trem5->wait(1);
