    ...
    ui(new Ui::MainWindow)
{
    ...
    trem1 = new Trem(1,230,30,TRAIN_CAN_MOVE,100);
    trem2 = new Trem(2,500,30,TRAIN_CAN_MOVE,100);
    trem3 = new Trem(3,100,150,TRAIN_CAN_MOVE,100);
    trem4 = new Trem(4,370,150,TRAIN_CAN_MOVE,100);
    trem5 = new Trem(5,640,150,TRAIN_CAN_MOVE,100);
...
void MainWindow::checkFirstTrainCanMove(int x, int y) {
    if ((ui->label_trem1->x() == 460 && ui->label_trem1->y() == 30) && (trem4->getCanMove() == TRAIN_CANNOT_MOVE && fourthCriticalRegion.available() == 1) && firstCriticalRegion.available() == 0)
    {
        // AWAIT SECOND TRAIN
        ...
        trem1->wait(1);
    } else if ((ui->label_trem1->x() == 460 && ui->label_trem1->y() == 30) && (ui->label_trem2->x() < 600) && firstCriticalRegion.available() == 0)
    {
        // AWAIT THIRD TRAIN
        firstCriticalRegion.release(1);
    ...
    } else if ((ui->label_trem1->x() == 410 && ui->label_trem1->y() == 150) && (ui->label_trem3->x() >= 210 && ui->label_trem3->y() == 150) && secondCriticalRegion.available() == 0)
    {
        ...
        trem1->setCanMove(TRAIN_CANNOT_MOVE);
        trem1->wait(1);
    } else if ((ui->label_trem1->x() == 500 && ui->label_trem1->y() == 120) && (trem3->getCanMove() == TRAIN_CANNOT_MOVE && sixthCriticalRegion.available() == 1) && thirdCriticalRegion.available() == 0)
    {
        // AWAIT FOURTH TRAIN
        thirdCriticalRegion.release(1);
        qDebug() << "RELEASE BY FIRST TRAIN, SIXTH CRITICAL REGION AVAILABLE: " << thirdCriticalRegion.available();
        trem1->setCanMove(TRAIN_CANNOT_MOVE);
        trem1->wait(1);
    } else if ((ui->label_trem1->x() == 500 && ui->label_trem1->y() == 120) && ((ui->label_trem3->x() >= 210 && ui->label_trem3->y() == 150) && (ui->label_trem4->x() == 370 && ui->label_trem4->y() <= 300)) && thirdCriticalRegion.available() == 0)
    {
        // AWAIT FOURTH TRAIN
        thirdCriticalRegion.release(1);
        qDebug() << "RELEASE BY FIRST TRAIN, SIXTH CRITICAL REGION AVAILABLE: " << thirdCriticalRegion.available();
...
void MainWindow::checkSecondTrainCanMove(int x, int y) {
     if ((ui->label_trem2->x() == 540 && ui->label_trem2->y() == 150) && ui->label_trem1->x() > 470 && firstCriticalRegion.available() == 0) {
         ...
         trem2->wait(1);
     } else if ((ui->label_trem2->x() == 660 && ui->label_trem2->y() == 150) && (ui->label_trem4->x() > 390 && ui->label_trem4->x() <= 640 && (ui->label_trem4->y() == 150 || ui->label_trem4->y() < 170)) && fourthCriticalRegion.available() == 0) {
         // AWAIT FOURTH TRAIN
     ...
     else if ((ui->label_trem2->x() == 770 && ui->label_trem2->y() == 130) && ((ui->label_trem5->x() >= 640 && ui->label_trem5->x() < 800 && ui->label_trem5->y() == 150) || (ui->label_trem5->x() < 660 && ui->label_trem4->x() > 480 && ui->label_trem4->y() == 150) || (trem4->getCanMove() == TRAIN_CANNOT_MOVE && seventhCriticalRegion.available() == 1)) && fifthCriticalRegion.available() == 0)
     {
         // AWAIT FIFTH TRAIN
...
void MainWindow::checkThirdTrainCanMove(int x, int y) {
    if ((ui->label_trem3->x() == 200 && ui->label_trem3->y() == 150) && ((ui->label_trem1->x() <= 400 && ui->label_trem1->y() == 150) || trem4->getCanMove() == TRAIN_CANNOT_MOVE && thirdCriticalRegion.available() == 1) && secondCriticalRegion.available() == 0)
    {
        // AWAIT FIRST TRAIN
        secondCriticalRegion.release(1);
    ...
    else if ((ui->label_trem3->x() == 330 && ui->label_trem3->y() == 150) && (ui->label_trem4->x() == 370) && sixthCriticalRegion.available() == 0)
    {
        // AWAIT FOURTH TRAIN
...
void MainWindow::checkFourthTrainCanMove(int x, int y) {
    if ((ui->label_trem4->x() == 370 && ui->label_trem4->y() == 180) && ((((ui->label_trem1->x() > 340 && ui->label_trem1->x() <= 500) && (ui->label_trem1->y() == 120)) || (ui->label_trem1->x() <= 500) && (ui->label_trem1->y() >= 120)) && thirdCriticalRegion.available() == 0)) {
        // AWAIT FIRST TRAIN
        thirdCriticalRegion.release(1);
    ...
    else if ((ui->label_trem4->x() == 400 && ui->label_trem4->y() == 300) && (((ui->label_trem1->x() <= 500) && (ui->label_trem1->y() == 150)) && ((ui->label_trem3->x() >= 120) && (ui->label_trem1->y() == 150))) && sixthCriticalRegion.available() == 0) {
        // AWAIT THIRD TRAIN
        sixthCriticalRegion.release(1);
    ...
    else if ((ui->label_trem4->x() == 480 && ui->label_trem4->y() == 150) && ((ui->label_trem2->x() < 660 && ui->label_trem2->y() == 150) || (ui->label_trem2->x() <= 770 && ui->label_trem2->y() == 150 && ui->label_trem5->x() < 660) || (trem2->getCanMove() == TRAIN_CANNOT_MOVE && fifthCriticalRegion.available() == 1)) && fourthCriticalRegion.available() == 0)
    {
        // AWAIT SECOND TRAIN
        fourthCriticalRegion.release(1);
    ...
    else if ((ui->label_trem4->x() == 400 && ui->label_trem4->y() == 300) && (ui->label_trem3->x() == 370 && ui->label_trem3->y() >= 150) && sixthCriticalRegion.available() == 0)
    {
        // AWAIT THIRD TRAIN
        sixthCriticalRegion.release(1);
        qDebug() << "RELEASE BY FOURTH TRAIN, SIXTH CRITICAL REGION AVAILABLE: " << sixthCriticalRegion.available();
    ...
    else if ((ui->label_trem4->x() == 620 && ui->label_trem4->y() == 150) && (ui->label_trem5->x() <= 660) && seventhCriticalRegion.available() == 0)
    {
        // AWAIT FIFTH TRAIN
...
void MainWindow::checkFifthTrainCanMove(int x, int y) {
    if ((ui->label_trem5->x() == 640 && ui->label_trem5->y() == 170) && (ui->label_trem2->x() > 620 && ui->label_trem2->x() <= 770 && ui->label_trem2->y() == 150) && fifthCriticalRegion.available() == 0) {
        // AWAIT SECOND TRAIN
        fifthCriticalRegion.release(1);
    ...
    else if ((ui->label_trem5->x() == 660 && ui->label_trem5->y() == 300) && ((ui->label_trem4->x() > 620) || (trem2->getCanMove() == TRAIN_CANNOT_MOVE && fourthCriticalRegion.available() == 1) || (ui->label_trem4->x() > 480 && ui->label_trem4->y() == 150 && ui->label_trem2->x() <= 770 && ui->label_trem2->y() == 150)) && seventhCriticalRegion.available() == 0)
    {
        // AWAIT FOURTH TRAIN
        seventhCriticalRegion.release(1);
...
void MainWindow::updateInterface(int id, int x, int y){
    ...
    case 5: //Atualiza a posição do objeto da tela (quadrado) que representa o trem5
        this->checkFifthTrainCanMove(x, y);
        break;
    default:
        break;
    }
...
void MainWindow::on_controllerTrainOne_valueChanged(int value)
{
    trem1->changeVelocity(value);
}

void MainWindow::on_controllerTrainTwo_valueChanged(int value)
{
    trem2->changeVelocity(value);
}

void MainWindow::on_controllerTrainThree_valueChanged(int value)
{
    trem3->changeVelocity(value);
}

void MainWindow::on_controllerTrainFour_valueChanged(int value)
{
    trem4->changeVelocity(value);
}

void MainWindow::on_controllerTrainFive_valueChanged(int value)
{
